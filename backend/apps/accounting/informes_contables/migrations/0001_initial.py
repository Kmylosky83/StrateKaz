    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nombre",
                    models.CharField(max_length=200, verbose_name="Nombre del Informe"),
                ),
                (
                    "tipo_informe",
                    models.CharField(
                ...
                (
                    "incluye_saldo_cero",
                    models.BooleanField(
                        default=False, verbose_name="Incluye Saldos en Cero"
                    ),
                ),
                (
                    "descripcion",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fecha_desde",
                    models.DateField(db_index=True, verbose_name="Fecha Desde"),
                ),
                (
                    "fecha_hasta",
                    models.DateField(db_index=True, verbose_name="Fecha Hasta"),
                ),
                (
                    "resultado_json",
                    models.JSONField(default=dict, verbose_name="Resultado JSON"),
                ),
                (
                    "archivo_pdf",
                    models.FileField(
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="informes_contables.informecontable",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "codigo_linea",
                    models.CharField(max_length=20, verbose_name="Código de Línea"),
                ),
                (
                    "descripcion",
                ...
                (
                    "nivel_indentacion",
                    models.IntegerField(default=0, verbose_name="Nivel de Indentación"),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["empresa", "codigo"], name="accounting__empresa_6d5e3e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="informecontable",
            index=models.Index(
                fields=["tipo_informe"], name="accounting__tipo_in_b35d92_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="informecontable",
            constraint=models.UniqueConstraint(
                fields=("empresa", "codigo"), name="unique_informe_por_empresa"
            ),
        ),
        migrations.AddIndex(
            model_name="generacioninforme",
            index=models.Index(
                fields=["empresa", "informe", "created_at"],
                name="accounting__empresa_614e80_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="generacioninforme",
            index=models.Index(
                ...
                name="accounting__fecha_d_6ce68c_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="lineainforme",
            index=models.Index(
                fields=["informe", "secuencia"], name="accounting__informe_e50846_idx"
            ),
        ),
    ]
