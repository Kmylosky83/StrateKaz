    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "modulo_origen",
                    models.CharField(
                        db_index=True, max_length=50, verbose_name="Módulo de Origen"
                    ),
                ),
                (
                    "documento_origen_tipo",
                    models.CharField(
                        max_length=50, verbose_name="Tipo Documento Origen"
                    ),
                ),
                (
                    "documento_origen_id",
                    models.IntegerField(
                        db_index=True, verbose_name="ID Documento Origen"
                    ),
                ),
                (
                    "prioridad",
                ...
                (
                    "datos_json",
                    models.JSONField(default=dict, verbose_name="Datos JSON"),
                ),
                (
                    "mensaje_error",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["empresa", "estado", "prioridad"],
                        name="accounting__empresa_22a416_idx",
                    ),
                    models.Index(
                        fields=["modulo_origen", "documento_origen_id"],
                        name="accounting__modulo__acfc39_idx",
                    ),
                    models.Index(
                        fields=["estado", "proximo_intento_at"],
                        name="accounting__estado_43366f_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["empresa", "estado", "created_at"],
                        name="accounting__empresa_3e3559_idx",
                    ),
                    models.Index(
                        fields=["modulo_origen", "documento_origen_id"],
                        name="accounting__modulo__bd0cfc_idx",
                    ),
                    models.Index(
                        fields=["estado"], name="accounting__estado_a4860f_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "configuracion_json",
                    models.JSONField(
                        blank=True, default=dict, verbose_name="Configuración JSON"
                    ),
                ),
                (
                    "activo",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="accounting__empresa_807ae9_idx",
                    ),
                    models.Index(
                        fields=["activo"], name="accounting__activo_54ac32_idx"
                    ),
                ],
            },
        ),
