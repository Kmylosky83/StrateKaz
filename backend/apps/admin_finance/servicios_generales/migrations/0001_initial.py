            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="admin_finan_empresa_d038aa_idx",
                    ),
                    models.Index(
                        fields=["codigo"], name="admin_finan_codigo_88b6ac_idx"
                    ),
                    models.Index(
                        fields=["tipo_servicio", "estado"],
                        name="admin_finan_tipo_se_20d4c8_idx",
                    ),
                    models.Index(
                    ...
                    models.Index(
                        ...
                        name="admin_finan_fecha_i_b06e7c_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["empresa", "estado"],
                        name="admin_finan_empresa_68c58f_idx",
                    ),
                    models.Index(
                        fields=["codigo"], name="admin_finan_codigo_93145c_idx"
                    ),
                    models.Index(
                        fields=["tipo", "estado"], name="admin_finan_tipo_ff143e_idx"
                    ),
                    models.Index(
                        fields=["fecha_solicitud"],
                        name="admin_finan_fecha_s_06a486_idx",
                    ),
                    models.Index(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="admin_finan_empresa_cbad0c_idx",
                    ),
                    models.Index(
                        fields=["codigo"], name="admin_finan_codigo_652831_idx"
                    ),
                    models.Index(
                        fields=["tipo_servicio", "periodo_anio", "periodo_mes"],
                        name="admin_finan_tipo_se_7a0d1c_idx",
                    ),
                    models.Index(
                        fields=["fecha_vencimiento"],
                        name="admin_finan_fecha_v_f1332c_idx",
                    ),
                ],
                "unique_together": {
                    (
