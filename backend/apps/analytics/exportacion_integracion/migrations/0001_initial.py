...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(default=0, verbose_name="Registros Exportados"),
                ),
                (
                    "archivo_generado",
                    models.FileField(
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="logs",
                        to="exportacion_integracion.configuracionexportacion",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["empresa", "tipo_exportacion"],
                name="analytics_c_empresa_c2a3e1_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="configuracionexportacion",
            index=models.Index(
                fields=["esta_activa"], name="analytics_c_esta_ac_46067d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="configuracionexportacion",
            index=models.Index(
                fields=["empresa", "is_active"], name="analytics_c_empresa_8ba2d7_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="logexportacion",
            index=models.Index(
                fields=["empresa", "configuracion"],
                name="analytics_l_empresa_c50ddd_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="logexportacion",
            index=models.Index(
                fields=["fecha_ejecucion"], name="analytics_l_fecha_e_28b56d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="logexportacion",
        ...
        migrations.AddIndex(
            model_name="logexportacion",
            index=models.Index(
                fields=["usuario"], name="analytics_l_usuario_2e4138_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="logexportacion",
            index=models.Index(
                fields=["empresa", "is_active"], name="analytics_l_empresa_8bf539_idx"
            ),
        ),
    ]
