...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="informes_generados",
                        to="generador_informes.plantillainforme",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="generador_informes.informedinamico",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="generador_informes.programacioninforme",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["empresa", "tipo_informe"],
                name="analytics_p_empresa_ec2cc0_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="plantillainforme",
        ...
        migrations.AddIndex(
            model_name="plantillainforme",
            index=models.Index(
                fields=["empresa", "is_active"], name="analytics_p_empresa_8c8552_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="informedinamico",
            index=models.Index(
                fields=["empresa", "plantilla"], name="analytics_i_empresa_236d66_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="informedinamico",
        ...
        migrations.AddIndex(
            model_name="informedinamico",
            index=models.Index(
                fields=["fecha_generacion"], name="analytics_i_fecha_g_02404e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="informedinamico",
            index=models.Index(
                fields=["empresa", "is_active"], name="analytics_i_empresa_4bf5e3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="programacioninforme",
            index=models.Index(
                fields=["empresa", "plantilla"], name="analytics_p_empresa_7404e0_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="programacioninforme",
            index=models.Index(
                fields=["esta_activa", "proxima_ejecucion"],
                name="analytics_p_esta_ac_1443f3_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="programacioninforme",
            index=models.Index(
                fields=["empresa", "is_active"], name="analytics_p_empresa_1880e8_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="historialinforme",
            index=models.Index(
                fields=["empresa", "programacion"],
                name="analytics_h_empresa_4b41f7_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="historialinforme",
            index=models.Index(
                fields=["fecha_ejecucion"], name="analytics_h_fecha_e_29b215_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="historialinforme",
            index=models.Index(
                fields=["fue_exitoso", "fue_enviado"],
                name="analytics_h_fue_exi_139445_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="historialinforme",
            index=models.Index(
                fields=["empresa", "is_active"], name="analytics_h_empresa_c7f272_idx"
            ),
        ),
    ]
