...
class TestConfiguracionAuditoriaViewSet:
    ...
    def test_listar_configuraciones(self, authenticated_client, configuracion_auditoria):
        """
    ...
    def test_crear_configuracion(self, authenticated_client, empresa):
        """
    ...
    def test_actualizar_configuracion(self, authenticated_client, configuracion_auditoria):
        """
    ...
    def test_filtrar_por_modulo(self, authenticated_client, configuracion_auditoria, empresa, user):
        """
    ...
    def test_buscar_configuracion(self, authenticated_client, configuracion_auditoria):
        """
    ...
    def test_filtrar_activas(self, authenticated_client, configuracion_auditoria, empresa, user):
        """
    ...
    def test_ordenar_por_modulo(self, authenticated_client, configuracion_auditoria):
        """
...
class TestLogAccesoViewSet:
    ...
    def test_listar_logs_acceso(self, authenticated_client, log_acceso):
        """
    ...
    def test_ver_detalle_log_acceso(self, authenticated_client, log_acceso):
        """
    ...
    def test_no_permite_crear_log_acceso(self, authenticated_client, user):
        """
    ...
    def test_filtrar_exitosos(self, authenticated_client, log_acceso, log_acceso_fallido):
        """
    ...
    def test_filtrar_fallidos(self, authenticated_client, log_acceso, log_acceso_fallido):
        """
    ...
    def test_buscar_por_ip(self, authenticated_client, log_acceso):
        """
    ...
    def test_custom_action_por_usuario(self, authenticated_client, log_acceso, user):
        """
    ...
    def test_ordenar_por_fecha(self, authenticated_client, log_acceso):
        """
...
class TestLogCambioViewSet:
    ...
    def test_listar_logs_cambio(self, authenticated_client, log_cambio):
        """
    ...
    def test_ver_detalle_log_cambio(self, authenticated_client, log_cambio):
        """
    ...
    def test_filtrar_por_accion(self, authenticated_client, log_cambio, log_cambio_creacion):
        """
    ...
    def test_buscar_por_object_repr(self, authenticated_client, log_cambio):
        """
    ...
    def test_custom_action_por_objeto(self, authenticated_client, log_cambio):
        """
    ...
    def test_custom_action_por_usuario(self, authenticated_client, log_cambio, user):
        """
        Test: Custom action por_usuario
    ...
    def test_no_permite_modificar(self, authenticated_client, log_cambio):
        """
...
class TestLogConsultaViewSet:
    ...
    def test_listar_logs_consulta(self, authenticated_client, log_consulta):
        """
    ...
    def test_ver_detalle_log_consulta(self, authenticated_client, log_consulta):
        """
    ...
    def test_filtrar_por_modulo(self, authenticated_client, log_consulta, log_consulta_simple):
        """
    ...
    def test_filtrar_exportaciones(self, authenticated_client, log_consulta, log_consulta_simple):
        """
    ...
    def test_filtrar_consultas_normales(self, authenticated_client, log_consulta, log_consulta_simple):
        """
    ...
    def test_buscar_por_endpoint(self, authenticated_client, log_consulta):
        """
    ...
    def test_filtrar_por_usuario(self, authenticated_client, log_consulta, user):
        """
