...
def copy_proveedor_data(apps, schema_editor):
    ...
    CtProveedor = apps.get_model('catalogo_productos', 'Proveedor')
    CtTipoProveedor = apps.get_model('catalogo_productos', 'TipoProveedor')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('catalogo_productos', '0007_tipoproveedor_proveedor_and_more'),
