...
def backfill_parametro_acidez(apps, schema_editor):
    EspecCalidad = apps.get_model('catalogo_productos', 'ProductoEspecCalidad')
    Parametro = apps.get_model('catalogo_productos', 'ProductoEspecCalidadParametro')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('catalogo_productos', '0013_productoespeccalidadparametro'),
    ]
