...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "affected_entity_id",
                    models.PositiveIntegerField(
                        db_index=True, verbose_name="ID de entidad afectada"
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=dict,
                        help_text='Permisos específicos que sobreescriben los valores por defecto. Formato: {"section_code": {"can_view": true, "can_create": false, ...}}',
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=list,
                        help_text='Lista de códigos de secciones donde NO se aplicará esta plantilla. Formato: ["section_code1", "section_code2"]',
        ...
        migrations.CreateModel(
            name="PermissionTemplateApplication",
            fields=[
                (
                    "id",
                    models.BigAutoField(
                ...
                (
                    "sections_created",
                    models.PositiveIntegerField(
                        default=0, verbose_name="Secciones creadas"
                    ),
                ),
                (
                    "sections_updated",
                    models.PositiveIntegerField(
                        default=0, verbose_name="Secciones actualizadas"
                    ),
                ),
                (
                    "sections_skipped",
                    models.PositiveIntegerField(
                        default=0, verbose_name="Secciones omitidas"
                    ),
                ),
                (
                    "replace_mode",
