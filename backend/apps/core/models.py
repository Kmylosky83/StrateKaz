...
class Cargo(models.Model):
    ...
    # DEPRECATED: Campo temporal para migración de datos
    area_nombre = models.CharField(
        max_length=100,
        blank=True,
        null=True,
        verbose_name='[DEPRECATED] Área (texto)',
        help_text='Campo deprecated - usar campo area (FK)'
    )
...
class User(AbstractUser):
    ...
    sede_nombre = models.CharField(
        ...
        blank=True,
        null=True,
        verbose_name='[DEPRECATED] Sede (texto)',
        help_text='Campo deprecated - usar campo sede_asignada (FK)'
    )
...
# ==========================================================================
# Los módulos, acciones y alcances se definen en la BD, no en código.
# Esto permite que cada empresa configure su propio sistema de permisos.
# ==========================================================================
