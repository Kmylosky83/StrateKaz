...
class EmpresaConfig(TimestampedModel):
    ...
    # =========================================================================
    # NOTA: BRANDING MIGRADO A BrandingConfig
    # =========================================================================
    # Los campos de branding (logo, colores, gradientes, PWA) fueron migrados
    # a apps.core.models.BrandingConfig como fuente única de verdad.
    # Para branding por tenant, usar Tenant.primary_color y Tenant.logo_url.
    # =========================================================================
