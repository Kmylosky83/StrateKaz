...
from .serializers import UnidadNegocioSerializer, UnidadNegocioListSerializer


class UnidadNegocioViewSet(viewsets.ModelViewSet):
    """
    ViewSet para Unidades de Negocio — Fundación Tab 1 (Mi Empresa).

    Endpoints:
    - GET /api/fundacion/configuracion/unidades-negocio/
    - POST /api/fundacion/configuracion/unidades-negocio/
    - GET /api/fundacion/configuracion/unidades-negocio/{id}/
    - PUT/PATCH /api/fundacion/configuracion/unidades-negocio/{id}/
    - DELETE /api/fundacion/configuracion/unidades-negocio/{id}/ (soft delete)
    - POST /api/fundacion/configuracion/unidades-negocio/{id}/restore/
    """
    ...
    def get_serializer_class(self):
        if self.action == 'list':
            return UnidadNegocioListSerializer
        return UnidadNegocioSerializer
