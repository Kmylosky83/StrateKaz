...
PREGUNTAS_PCI_POAM = [
    ...
    # =========================================================================
    # PCI - CAPACIDAD TECNOLÓGICA (27-36)
    # =========================================================================
    {
    ...
    # =========================================================================
    # POAM - FACTORES ECONÓMICOS (53-58)
    # =========================================================================
    {
    ...
    # =========================================================================
    # POAM - FACTORES TECNOLÓGICOS (70-72)
    # =========================================================================
    {
    ...
    # =========================================================================
    # POAM - FACTORES GEOGRÁFICOS (73-75) → mapean a ecológico en PESTEL
    # =========================================================================
    {
