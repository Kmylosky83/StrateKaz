# Generated by Django 5.0.14 on 2026-03-16 22:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tipo_encuesta",
                    models.CharField(
                        choices=[("libre", "Libre"), ("pci_poam", "PCI-POAM")],
                        default="libre",
                ...
                (
                    "titulo",
                    models.CharField(
                        max_length=200, verbose_name="Título de la Encuesta"
                    ),
                ),
                (
                    "descripcion",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0, verbose_name="Total Invitados"
                    ),
                ),
                (
                    "total_respondidos",
                    models.PositiveIntegerField(
                        default=0, verbose_name="Total Respondidos"
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Fecha Inicio Respuesta"
                    ),
                ),
                (
                    "fecha_completado",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("pci", "PCI - Perfil de Capacidad Interna"),
                            ("poam", "POAM - Perfil de Oportunidades y Amenazas"),
                        ],
                        max_length=5,
                        verbose_name="Perfil",
                    ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["perfil", "capacidad_pci"],
                        name="encuestas_p_perfil_f2de5c_idx",
                    ),
                    models.Index(
                        fields=["perfil", "factor_poam"],
                        name="encuestas_p_perfil_2a0e48_idx",
                    ),
                    models.Index(
                        fields=["codigo"], name="encuestas_p_codigo_6f08e0_idx"
                    ),
                ],
            },
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["empresa", "estado"], name="encuestas_d_empresa_03924c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="encuestadofa",
            index=models.Index(
                fields=["token_publico"], name="encuestas_d_token_p_2c1d4d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="encuestadofa",
            index=models.Index(
                ...
                name="encuestas_d_fecha_i_1f8ccb_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="participanteencuesta",
            index=models.Index(
                fields=["encuesta", "estado"], name="encuestas_p_encuest_4354d2_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="participanteencuesta",
            index=models.Index(
                fields=["usuario"], name="encuestas_p_usuario_a33c35_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="temaencuesta",
            index=models.Index(
                fields=["encuesta", "orden"], name="encuestas_t_encuest_722f80_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="respuestaencuesta",
            index=models.Index(
                fields=["tema", "clasificacion"], name="encuestas_r_tema_id_83d0cd_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="respuestaencuesta",
            index=models.Index(
                fields=["respondente"], name="encuestas_r_respond_15906e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="respuestaencuesta",
            index=models.Index(
                fields=["token_anonimo"], name="encuestas_r_token_a_8a96cf_idx"
            ),
        ),
