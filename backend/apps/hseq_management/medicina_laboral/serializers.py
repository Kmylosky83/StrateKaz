...
class ExamenMedicoSerializer(serializers.ModelSerializer):
    ...
    # colaborador_nombre viene del modelo directamente (campo cache)

    class Meta:
        model = ExamenMedico
        fields = [
            'id', 'empresa_id', 'numero_examen', 'tipo_examen', 'tipo_examen_nombre',
            'colaborador_id', 'colaborador_nombre', 'cargo', 'fecha_programada', 'fecha_realizado',
...
class RestriccionMedicaSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'examen_medico_numero', 'colaborador_id', 'colaborador_nombre', 'cargo',
...
class RestriccionMedicaListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = RestriccionMedica
        fields = [
            'id', 'codigo_restriccion', 'colaborador_id', 'colaborador_nombre',
            'tipo_restriccion', 'tipo_restriccion_display', 'categoria',
...
class CasoVigilanciaSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'programa_tipo', 'colaborador_id', 'colaborador_nombre', 'cargo',
