# -*- coding: utf-8 -*-
"""
Modelos para Planificacion del Sistema - HSEQ Management

Este modulo maneja la planificacion integral del sistema HSEQ:
...
class PlanTrabajoAnual(models.Model):
    ...
    responsable = models.ForeignKey(
        ...
        help_text='Responsable de coordinar el plan (ej: Coordinador HSEQ)'
    )
