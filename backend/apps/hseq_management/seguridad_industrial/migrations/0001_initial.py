    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False, help_text="Requiere capacitación para su uso"
                    ),
                ),
                ("activo", models.BooleanField(default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False, help_text="Requiere autorización de operaciones"
                    ),
                ),
                (
                ...
                (
                    "epp_requeridos",
                    models.JSONField(
                        default=list, help_text="EPP requeridos ['Casco', 'Arnés', ...]"
                    ),
                ),
                ("orden", models.IntegerField(default=0)),
                ("activo", models.BooleanField(default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ubicacion",
                    models.CharField(
                        help_text="Lugar específico de la inspección", max_length=200
                    ),
                ),
                ...
                (
                    "fotos",
                    models.JSONField(
                        default=list, help_text="URLs de fotos de la inspección"
                    ),
                ),
                (
                    "documentos",
                    models.JSONField(
                        default=list, help_text="URLs de documentos adjuntos"
                    ),
                ),
                (
                    "acompanante",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="seguridad_industrial.plantillainspeccion",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "item_plantilla_id",
                    models.IntegerField(help_text="ID del item en la plantilla"),
                ),
                ...
                (
                    "accion_requerida",
                    models.TextField(
                        blank=True, help_text="Acción correctiva o preventiva requerida"
                    ),
                ),
                (
                    "foto",
                    models.URLField(
                        blank=True, help_text="URL de foto del item inspeccionado"
                    ),
                ),
                (
                    "genera_hallazgo",
                    models.BooleanField(
                        default=False, help_text="Si genera hallazgo/no conformidad"
                    ),
                ),
                (
                    "hallazgo_id",
                    models.IntegerField(
                        blank=True, help_text="ID del hallazgo generado", null=True
                    ),
                ),
                (
                    "inspeccion",
                    models.ForeignKey(
                        ...
                        to="seguridad_industrial.inspeccion",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="seguridad_industrial.tipoinspeccion",
            ),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "epp_verificado",
                    models.JSONField(
                        default=list, help_text="EPP verificado como utilizado"
                    ),
                ),
                (
                    "requiere_vigilia",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="seguridad_industrial.tipopermisotrabajo",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "objetivos",
                    models.JSONField(
                        default=list, help_text="Lista de objetivos del programa"
                    ),
                ),
                (
                    "indicadores",
                ...
                (
                    "recursos_requeridos",
                    models.TextField(
                        blank=True, help_text="Descripción de recursos necesarios"
                    ),
                ),
                (
                    "estado",
                ...
                (
                    "normativa_aplicable",
                    models.TextField(
                        blank=True, help_text="Normativa o estándares aplicables"
                    ),
                ),
                ("activo", models.BooleanField(default=True)),
                (
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="hseq_progra_empresa_420810_idx",
                    ),
                    models.Index(
                        fields=["empresa_id", "fecha_inicio"],
                        name="hseq_progra_empresa_8ba7e0_idx",
                    ),
                ],
                "unique_together": {("empresa_id", "codigo")},
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False, help_text="Se realizó capacitación sobre el uso"
                    ),
                ),
                ...
                (
                    "firma_colaborador",
                    models.TextField(
                        blank=True, help_text="Firma digital del colaborador que recibe"
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="seguridad_industrial.tipoepp",
                    ),
                ),
            ],
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["empresa_id", "estado"],
                        name="hseq_entreg_empresa_64e34d_idx",
                    ),
                    models.Index(
                        fields=["empresa_id", "colaborador", "estado"],
                        name="hseq_entreg_empresa_c0930f_idx",
                    ),
                    models.Index(
                        fields=["numero_entrega"], name="hseq_entreg_numero__5e6403_idx"
                    ),
                ],
            },
        ),
        migrations.AddIndex(
            model_name="inspeccion",
            index=models.Index(
                fields=["empresa_id", "estado"], name="hseq_inspec_empresa_7101a1_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="inspeccion",
            index=models.Index(
                fields=["empresa_id", "fecha_programada"],
                name="hseq_inspec_empresa_2beeee_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="inspeccion",
            index=models.Index(
                fields=["numero_inspeccion"], name="hseq_inspec_numero__f2c3aa_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="permisotrabajo",
            index=models.Index(
                fields=["empresa_id", "estado"], name="hseq_permis_empresa_4dff39_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="permisotrabajo",
            index=models.Index(
                fields=["empresa_id", "fecha_inicio"],
                name="hseq_permis_empresa_40de07_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="permisotrabajo",
            index=models.Index(
                fields=["numero_permiso"], name="hseq_permis_numero__d47d59_idx"
            ),
        ),
    ]
