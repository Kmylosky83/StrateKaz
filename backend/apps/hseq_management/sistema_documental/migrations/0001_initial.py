    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "requiere_firma",
                    models.BooleanField(
                        default=True, verbose_name="Requiere Firma Digital"
                    ),
                ),
                (
                    "tiempo_retencion_años",
                    models.IntegerField(
                        default=5,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "codigo",
                    models.CharField(max_length=50, verbose_name="Código de Plantilla"),
                ),
                (
                    "nombre",
                    models.CharField(
                ...
                (
                    "es_por_defecto",
                    models.BooleanField(
                        default=False, verbose_name="¿Es Plantilla por Defecto?"
                    ),
                ),
                (
                    "empresa_id",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="sistema_documental.tipodocumento",
                        verbose_name="Tipo de Documento",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "titulo",
                    models.CharField(
                        max_length=255, verbose_name="Título del Documento"
                    ),
                ),
                (
                    "resumen",
                ...
                (
                    "fecha_obsolescencia",
                    models.DateField(
                        blank=True, null=True, verbose_name="Fecha de Obsolescencia"
                    ),
                ),
                (
                    "areas_aplicacion",
                ...
                (
                    "numero_impresiones",
                    models.IntegerField(
                        default=0, verbose_name="Número de Impresiones"
                    ),
                ),
                (
                    "observaciones",
                ...
                (
                    "motivo_cambio_version",
                    models.TextField(
                        blank=True, verbose_name="Motivo del Cambio de Versión"
                    ),
                ),
                (
                    "empresa_id",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="sistema_documental.documento",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="sistema_documental.plantilladocumento",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "longitud_maxima",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Longitud Máxima"
                    ),
                ),
                (
                    "columnas_tabla",
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True, verbose_name="Fecha de la Versión"
                    ),
                ),
                (
                    "fecha_aprobacion",
                ...
                (
                    "is_version_actual",
                    models.BooleanField(
                        default=False, verbose_name="¿Es Versión Actual?"
                    ),
                ),
                (
                    "checksum",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="firmas",
                        to="sistema_documental.versiondocumento",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fecha_distribucion",
                    models.DateField(
                        blank=True, null=True, verbose_name="Fecha de Distribución"
                    ),
                ),
                (
                    "medio_distribucion",
                ...
                (
                    "numero_copias_impresas",
                    models.IntegerField(
                        default=0, verbose_name="Número de Copias Impresas"
                    ),
                ),
                (
                    "numero_copias_controladas",
                    models.IntegerField(
                        default=0,
                ...
                (
                    "motivo_retiro",
                    models.TextField(
                        blank=True, verbose_name="Motivo de Retiro/Obsolescencia"
                    ),
                ),
                (
                    "confirmaciones_recepcion",
                    models.JSONField(
                        blank=True,
                        default=list,
                ...
                (
                    "fecha_destruccion",
                    models.DateField(
                        blank=True, null=True, verbose_name="Fecha de Destrucción"
                    ),
                ),
                (
                    "metodo_destruccion",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["empresa_id", "tipo_documento"],
        ...
        migrations.AddIndex(
            model_name="plantilladocumento",
            index=models.Index(
                fields=["empresa_id", "estado"], name="documental__empresa_e6003c_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="plantilladocumento",
        ...
        migrations.AddIndex(
            model_name="documento",
            index=models.Index(
                fields=["empresa_id", "estado"], name="documental__empresa_4a0935_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="documento",
        ...
        migrations.AddIndex(
            model_name="documento",
            index=models.Index(
                fields=["fecha_revision_programada"],
                name="documental__fecha_r_4a9bc1_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="documento",
        ...
        migrations.AddIndex(
            model_name="versiondocumento",
            index=models.Index(
                fields=["fecha_version"], name="documental__fecha_v_0bc086_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="versiondocumento",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["empresa_id", "documento"],
                name="documental__empresa_fccdaf_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="firmadocumento",
            index=models.Index(
                fields=["empresa_id", "firmante"], name="documental__empresa_3950cc_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="firmadocumento",
            index=models.Index(
                fields=["empresa_id", "estado"], name="documental__empresa_796738_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="firmadocumento",
            index=models.Index(
                fields=["fecha_firma"], name="documental__fecha_f_1ebdb0_idx"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name="controldocumental",
            index=models.Index(
                fields=["empresa_id", "tipo_control"],
        ...
        migrations.AddIndex(
            model_name="controldocumental",
            index=models.Index(
                fields=["fecha_distribucion"], name="documental__fecha_d_d97d2d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="controldocumental",
            index=models.Index(
                fields=["fecha_retiro"], name="documental__fecha_r_b265fe_idx"
            ),
        ),
    ]
