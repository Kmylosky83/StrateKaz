...
class CategoriaProducto(TenantModel):
    ...
    class Meta:
        ...
        db_table = 'catalogo_productos_categoriaproducto'
...
class UnidadMedida(TenantModel):
    ...
    class Meta:
        # db_table preservado tras rename app_label catalogo_productos → infra_catalogo_productos (Fase 2.2 CT)
        db_table = 'catalogo_productos_unidadmedida'
...
class Producto(TenantModel):
    ...
    class Meta:
        # db_table preservado tras rename app_label catalogo_productos → infra_catalogo_productos (Fase 2.2 CT)
        db_table = 'catalogo_productos_producto'
...
from apps.infraestructura.catalogo_productos.extensiones.espec_calidad import ProductoEspecCalidad  # noqa: E402, F401
from apps.infraestructura.catalogo_productos.extensiones.espec_calidad_parametro import ProductoEspecCalidadParametro  # noqa: E402, F401

# Sub-paquete Proveedores (CT-layer, 2026-04-21).
# Vive en el mismo app_label='infra_catalogo_productos' — ver Meta en los modelos.
from apps.infraestructura.catalogo_productos.proveedores.models import Proveedor, TipoProveedor  # noqa: E402, F401
