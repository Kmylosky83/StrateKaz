...
Doctrina 2026-04-21 (Opción A - separación estricta):
  CT NO importa de C2. El CRUD de Proveedor aquí gestiona SOLO datos CT
  (identificación, contacto, productos_suministrados M2M). Los precios
  y modalidad logística son responsabilidad de supply_chain — ver
...
class ProveedorViewSet(viewsets.ModelViewSet):
    ...
    # Action asignar-precios eliminado 2026-04-21 (Opción A separación estricta).
    # La asignación masiva vive ahora en supply_chain:
    # POST /api/supply-chain/precios-mp/batch-por-proveedor/
