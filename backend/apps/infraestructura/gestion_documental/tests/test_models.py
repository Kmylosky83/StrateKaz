...
class TestTipoDocumento:
    ...
    def test_crear_tipo_documento_basico(self, user):
        ...
        from apps.infraestructura.gestion_documental.models import TipoDocumento
...
class TestPlantillaDocumento:
    ...
    def test_crear_plantilla_basica(self, tipo_documento, user):
        ...
        from apps.infraestructura.gestion_documental.models import PlantillaDocumento
...
class TestVersionDocumento:
    ...
    def test_crear_version_basica(self, documento, user):
        ...
        from apps.infraestructura.gestion_documental.models import VersionDocumento
