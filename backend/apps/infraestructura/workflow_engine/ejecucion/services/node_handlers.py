...
class FinNodeHandler(BaseNodeHandler):
    ...
    @classmethod
    def handle(cls, instancia, nodo, usuario=None, datos_contexto=None):
        from apps.infraestructura.workflow_engine.ejecucion.models import (
...
class TareaNodeHandler(BaseNodeHandler):
    ...
    def handle(cls, instancia, nodo, usuario=None, datos_contexto=None):
        ...
        from apps.infraestructura.workflow_engine.ejecucion.signals import tarea_creada
...
class GatewayExclusivoHandler(BaseNodeHandler):
    ...
    def handle(cls, instancia, nodo, usuario=None, datos_contexto=None):
        from apps.infraestructura.workflow_engine.disenador_flujos.models import TransicionFlujo
        from apps.infraestructura.workflow_engine.monitoreo.models import AlertaFlujo
...
class EventoNodeHandler(BaseNodeHandler):
    ...
    def _handle_timer(cls, instancia, nodo, config):
        ...
        try:
            from apps.infraestructura.workflow_engine.ejecucion.tasks import ejecutar_evento_temporizador
