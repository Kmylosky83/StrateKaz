...
@shared_task(
    bind=True,
    name='apps.infraestructura.workflow_engine.ejecucion.tasks.verificar_tareas_vencidas',
    max_retries=2,
...
def _verificar_tareas_en_tenant(ahora):
    ...
    from apps.infraestructura.workflow_engine.ejecucion.models import TareaActiva, NotificacionFlujo
    from apps.infraestructura.workflow_engine.monitoreo.models import AlertaFlujo, ReglaSLA
...
@shared_task(
    bind=True,
    name='apps.infraestructura.workflow_engine.ejecucion.tasks.enviar_notificacion_workflow',
    max_retries=3,
...
def enviar_notificacion_workflow(self, notificacion_id: int, schema_name: str = None):
    ...
    """
    from django_tenants.utils import schema_context
    from apps.infraestructura.workflow_engine.ejecucion.models import NotificacionFlujo
...
@shared_task(
    bind=True,
    name='apps.infraestructura.workflow_engine.ejecucion.tasks.ejecutar_evento_temporizador',
    max_retries=2,
...
@shared_task(
    bind=True,
    name='apps.infraestructura.workflow_engine.ejecucion.tasks.actualizar_metricas_flujo',
    max_retries=1,
    time_limit=10 * 60,
...
def _actualizar_metricas_en_tenant(ahora, inicio_mes):
    ...
    from apps.infraestructura.workflow_engine.ejecucion.models import InstanciaFlujo, TareaActiva
    from apps.infraestructura.workflow_engine.monitoreo.models import MetricaFlujo
