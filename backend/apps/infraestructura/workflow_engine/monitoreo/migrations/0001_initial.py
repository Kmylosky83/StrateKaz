    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('retraso', 'Retraso'), ('escalamiento', 'Escalamiento'), ('error', 'Error'), ('vencimiento', 'Vencimiento')], max_length=20)),
                ...
                ('estado', models.CharField(choices=[('activa', 'Activa'), ('atendida', 'Atendida'), ('ignorada', 'Ignorada')], default='activa', max_length=20)),
                ('empresa_id', models.PositiveBigIntegerField()),
                ('atendida_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='workflow_alertas_atendidas', to=settings.AUTH_USER_MODEL)),
                ...
                ('instancia', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='alertas', to='infra_workflow_ejecucion.instanciaflujo')),
                ('tarea', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='alertas', to='infra_workflow_ejecucion.tareaactiva')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_deleted', models.BooleanField(db_index=True, default=False, verbose_name='Eliminado')),
                ('deleted_at', models.DateTimeField(blank=True, null=True, verbose_name='Fecha de eliminación')),
                ('tipo_widget', models.CharField(choices=[('kpi', 'KPI'), ('grafico', 'Gráfico'), ('lista', 'Lista'), ('tabla', 'Tabla')], max_length=20)),
                ('titulo', models.CharField(max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accion_vencimiento', models.CharField(choices=[('notificar', 'Notificar'), ('escalar', 'Escalar'), ('reasignar', 'Reasignar')], default='notificar', max_length=20)),
                ('destinatarios_alerta', models.TextField()),
                ('is_active', models.BooleanField(default=True)),
                ('empresa_id', models.PositiveBigIntegerField()),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL, verbose_name='Creado por')),
                ('deleted_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL, verbose_name='Eliminado por')),
                ('nodo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reglas_sla', to='infra_disenador_flujos.nodoflujo')),
                ('plantilla', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reglas_sla', to='infra_disenador_flujos.plantillaflujo')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL, verbose_name='Actualizado por')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frecuencia', models.CharField(choices=[('diario', 'Diario'), ('semanal', 'Semanal'), ('mensual', 'Mensual')], max_length=20)),
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL, verbose_name='Creado por')),
                ('deleted_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL, verbose_name='Eliminado por')),
                ('plantillas_incluidas', models.ManyToManyField(related_name='reportes_automaticos', to='infra_disenador_flujos.plantillaflujo')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL, verbose_name='Actualizado por')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_deleted', models.BooleanField(db_index=True, default=False, verbose_name='Eliminado')),
                ('deleted_at', models.DateTimeField(blank=True, null=True, verbose_name='Fecha de eliminación')),
                ('periodo', models.CharField(choices=[('mensual', 'Mensual'), ('trimestral', 'Trimestral'), ('anual', 'Anual')], max_length=20)),
                ...
                ('tiempo_promedio_dias', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL, verbose_name='Creado por')),
                ('deleted_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL, verbose_name='Eliminado por')),
                ('plantilla', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='metricas', to='infra_disenador_flujos.plantillaflujo')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL, verbose_name='Actualizado por')),
            ],
            options={
