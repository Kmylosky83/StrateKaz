...
class MetricaFlujo(TenantModel):
    ...
    plantilla = models.ForeignKey('infra_disenador_flujos.PlantillaFlujo', on_delete=models.CASCADE, related_name='metricas')
...
class AlertaFlujo(TenantModel):
    ...
    instancia = models.ForeignKey('infra_workflow_ejecucion.InstanciaFlujo', on_delete=models.CASCADE, related_name='alertas')
    tarea = models.ForeignKey('infra_workflow_ejecucion.TareaActiva', on_delete=models.SET_NULL, null=True, blank=True, related_name='alertas')
...
class ReglaSLA(TenantModel):
    ...
    plantilla = models.ForeignKey('infra_disenador_flujos.PlantillaFlujo', on_delete=models.CASCADE, related_name='reglas_sla')
    nodo = models.ForeignKey('infra_disenador_flujos.NodoFlujo', on_delete=models.CASCADE, null=True, blank=True, related_name='reglas_sla')
...
class ReporteAutomatico(TenantModel):
    ...
    plantillas_incluidas = models.ManyToManyField('infra_disenador_flujos.PlantillaFlujo', related_name='reportes_automaticos')
