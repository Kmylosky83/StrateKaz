    ...
    operations = [
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="logistics_e_codigo_6b6c3a_idx",
                    ),
                    models.Index(
                        fields=["disponible_para_ruta"],
                        name="logistics_e_disponi_8d386d_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["codigo", "is_active"],
                        name="logistics_t_codigo_33163f_idx",
                    ),
                    models.Index(fields=["orden"], name="logistics_t_orden_dc56a0_idx"),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fecha_matricula",
                    models.DateField(
                        blank=True, null=True, verbose_name="Fecha de matrícula"
                    ),
                ),
                (
                    "fecha_soat",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="gestion_flota.estadovehiculo",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fecha_ejecucion",
                    models.DateField(
                        blank=True, null=True, verbose_name="Fecha de ejecución real"
                    ),
                ),
                (
                    "km_mantenimiento",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fecha",
                    models.DateField(db_index=True, verbose_name="Fecha del evento"),
                ),
                (
                    "tipo_evento",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fecha",
                    models.DateField(db_index=True, verbose_name="Fecha del gasto"),
                ),
                (
                    "tipo_costo",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fecha",
                    models.DateTimeField(
                        db_index=True, verbose_name="Fecha y hora de verificación"
                    ),
                ),
                (
                    "tipo",
        ...
        migrations.AddIndex(
            model_name="vehiculo",
            index=models.Index(
                fields=["empresa", "is_active"], name="logistics_v_empresa_4e804f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="vehiculo",
        ...
        migrations.AddIndex(
            model_name="vehiculo",
            index=models.Index(
                fields=["estado", "is_active"], name="logistics_v_estado__b5b6c7_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="vehiculo",
            index=models.Index(
                fields=["fecha_soat"], name="logistics_v_fecha_s_38158c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="vehiculo",
            index=models.Index(
                fields=["fecha_tecnomecanica"], name="logistics_v_fecha_t_f78157_idx"
            ),
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="logistics_m_vehicul_87b4df_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="mantenimientovehiculo",
            index=models.Index(
                ...
                name="logistics_m_estado_179918_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="mantenimientovehiculo",
            index=models.Index(
                fields=["tipo", "-fecha_programada"], name="logistics_m_tipo_02c2dd_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="hojavidavehiculo",
            index=models.Index(
                fields=["vehiculo", "-fecha"], name="logistics_h_vehicul_771bb5_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="hojavidavehiculo",
            index=models.Index(
                fields=["tipo_evento", "-fecha"], name="logistics_h_tipo_ev_600d86_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="hojavidavehiculo",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["vehiculo", "tipo_documento"],
                name="logistics_d_vehicul_69d47f_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="documentovehiculo",
            index=models.Index(
                fields=["fecha_vencimiento", "is_active"],
                name="logistics_d_fecha_v_89149e_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="documentovehiculo",
            index=models.Index(
                fields=["tipo_documento", "fecha_vencimiento"],
                name="logistics_d_tipo_do_900f2d_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="costooperacion",
            index=models.Index(
                fields=["vehiculo", "-fecha"], name="logistics_c_vehicul_4c8567_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="costooperacion",
            index=models.Index(
                fields=["tipo_costo", "-fecha"], name="logistics_c_tipo_co_cdd3f9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="costooperacion",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["vehiculo", "-fecha"], name="logistics_v_vehicul_b481e3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="verificaciontercero",
            index=models.Index(
                fields=["tipo", "-fecha"], name="logistics_v_tipo_ccda89_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="verificaciontercero",
            index=models.Index(
                fields=["resultado", "-fecha"], name="logistics_v_resulta_3b31d1_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="verificaciontercero",
