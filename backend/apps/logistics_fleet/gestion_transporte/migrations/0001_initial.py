...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="gestion_transporte.estadodespacho",
                        verbose_name="Estado",
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="gestion_transporte.despacho",
                        verbose_name="Despacho",
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="gestion_transporte.conductor",
                        verbose_name="Conductor",
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="gestion_transporte.programacionruta",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="rutas",
                        to="gestion_transporte.tiporuta",
                        verbose_name="Tipo de ruta",
                    ),
                ),
            ],
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["empresa", "is_active"], name="transporte__empresa_97ac4c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="conductor",
            index=models.Index(
                fields=["documento_identidad"], name="transporte__documen_85d605_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["empresa", "fecha_expedicion"],
                name="transporte__empresa_50bf4a_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="manifiesto",
            index=models.Index(
                fields=["numero_manifiesto"], name="transporte__numero__06f3a4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="despacho",
            index=models.Index(
                fields=["empresa", "estado_despacho"],
                name="transporte__empresa_90ec91_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="despacho",
        ...
        migrations.AddIndex(
            model_name="despacho",
            index=models.Index(
                fields=["fecha_entrega_estimada"], name="transporte__fecha_e_0820ed_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="programacionruta",
            index=models.Index(
                fields=["empresa", "estado", "fecha_programada"],
                name="transporte__empresa_010d6c_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="programacionruta",
