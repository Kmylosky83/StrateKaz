    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nombre",
                    models.CharField(max_length=255, verbose_name="Nombre de la Señal"),
                ),
                (
                    "categoria",
                    models.CharField(
                ...
                (
                    "fecha_deteccion",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Fecha de Detección"
                    ),
                ),
                (
                    "origen_deteccion",
                ...
                (
                    "fecha_analisis",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Fecha de Análisis"
                    ),
                ),
                (
                    "resultado_analisis",
                    models.TextField(blank=True, verbose_name="Resultado del Análisis"),
                ),
                (
                    "estado",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fecha_deteccion",
                    models.DateField(verbose_name="Fecha de Detección"),
                ),
                (
                    "tipo_operacion",
                    models.CharField(
                        choices=[
                            ...
                            (
                                ...
                                "Administración de Recursos Ilícitos",
                            ),
                        ],
                        max_length=50,
                ...
                (
                    ...
                    models.CharField(
                        max_length=50, verbose_name="Identificación del Reportado"
                    ),
                ),
                (
                    "tipo_identificacion",
                ...
                (
                    "fecha_envio_uiaf",
                    models.DateField(
                        blank=True, null=True, verbose_name="Fecha de Envío a UIAF"
                    ),
                ),
                (
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["empresa_id", "estado"], name="sagrilaft_s_empresa_30972f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="señalalerta",
            index=models.Index(
                ...
                name="sagrilaft_s_empresa_4d7ce9_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="señalalerta",
            index=models.Index(
                ...
                name="sagrilaft_s_categor_9c5f76_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="señalalerta",
            index=models.Index(
                fields=["fecha_deteccion"], name="sagrilaft_s_fecha_d_5a8282_idx"
            ),
        ),
        migrations.AddIndex(
