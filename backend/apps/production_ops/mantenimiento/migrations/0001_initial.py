    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        to="mantenimiento.activoproduccion",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fecha_calibracion",
                    models.DateField(verbose_name="Fecha de Calibración"),
                ),
                (
                    "fecha_vencimiento",
                    models.DateField(
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="mantenimiento.equipomedicion",
                        verbose_name="Equipo de Medición",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fecha_fin",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Fin de Parada"
                    ),
                ),
                (
                    "duracion_horas",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["empresa", "estado"], name="mantenimien_empresa_00c1cf_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="equipomedicion",
            index=models.Index(
                fields=["fecha_proxima_calibracion"],
                name="mantenimien_fecha_p_1741dc_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="calibracion",
            index=models.Index(
                fields=["empresa", "equipo"], name="mantenimien_empresa_f6d742_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="calibracion",
            index=models.Index(
                fields=["fecha_vencimiento"], name="mantenimien_fecha_v_9f10c7_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="calibracion",
            index=models.Index(
                fields=["resultado"], name="mantenimien_resulta_f2ebd0_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="parada",
            index=models.Index(
                fields=["empresa", "activo"], name="mantenimien_empresa_496188_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="parada",
        ...
        migrations.AddIndex(
            model_name="parada",
            index=models.Index(
                fields=["fecha_inicio"], name="mantenimien_fecha_i_158915_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="activoproduccion",
            index=models.Index(
                fields=["empresa", "estado"], name="mantenimien_empresa_0235ac_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="activoproduccion",
            index=models.Index(
                fields=["tipo_activo", "estado"], name="mantenimien_tipo_ac_5e5572_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="activoproduccion",
            index=models.Index(
                fields=["fecha_proximo_mantenimiento"],
                name="mantenimien_fecha_p_83cff2_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="planmantenimiento",
            index=models.Index(
                fields=["empresa", "activo_plan"], name="mantenimien_empresa_080937_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="planmantenimiento",
            index=models.Index(
                fields=["activo", "activo_plan"], name="mantenimien_activo__89eaf0_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="planmantenimiento",
            index=models.Index(
                fields=["proxima_ejecucion"], name="mantenimien_proxima_0c0909_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="ordentrabajo",
            index=models.Index(
                fields=["empresa", "estado"], name="mantenimien_empresa_2d8139_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="ordentrabajo",
            index=models.Index(
                fields=["activo", "estado"], name="mantenimien_activo__45e566_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="ordentrabajo",
            index=models.Index(
                fields=["prioridad", "estado"], name="mantenimien_priorid_9a1707_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="ordentrabajo",
            index=models.Index(
                fields=["fecha_programada"], name="mantenimien_fecha_p_8e4dd0_idx"
            ),
        ),
    ]
