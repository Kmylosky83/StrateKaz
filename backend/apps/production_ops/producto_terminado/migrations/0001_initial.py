    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["codigo"], name="producto_te_codigo_1a1a33_idx"
                    ),
                    models.Index(
                        fields=["activo", "orden"], name="producto_te_activo_3e48e5_idx"
                    ),
                ],
            },
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="stocks",
                        to="producto_terminado.estadolote",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="producto_terminado.stockproducto",
                        verbose_name="Stock de Producto",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["codigo"], name="producto_te_codigo_4d28d1_idx"
                    ),
                    models.Index(
                        fields=["activo", "orden"], name="producto_te_activo_da8aac_idx"
                    ),
                ],
            },
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="producto_terminado.tipoproducto",
                verbose_name="Tipo de Producto",
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="producto_terminado.liberacion",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="producto_te_empresa_8812f7_idx",
                    ),
                    models.Index(
                        fields=["numero_certificado"],
                        name="producto_te_numero__6d431d_idx",
                    ),
                    models.Index(
                        fields=["fecha_emision"], name="producto_te_fecha_e_20b03c_idx"
                    ),
                    models.Index(
                        fields=["cliente_nombre"], name="producto_te_cliente_42cef5_idx"
                    ),
                ],
            },
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["empresa", "is_active"], name="producto_te_empresa_6d5d70_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="stockproducto",
            index=models.Index(
                fields=["producto", "estado_lote"],
                name="producto_te_product_140731_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="stockproducto",
            index=models.Index(
                fields=["codigo_lote_pt"], name="producto_te_codigo__34ea3f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="stockproducto",
            index=models.Index(
                fields=["fecha_vencimiento"], name="producto_te_fecha_v_6e2975_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="stockproducto",
            index=models.Index(
                fields=["fecha_produccion"], name="producto_te_fecha_p_16514e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="liberacion",
            index=models.Index(
                fields=["empresa", "is_active"], name="producto_te_empresa_87d122_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="liberacion",
            index=models.Index(
                fields=["stock_producto", "resultado"],
                name="producto_te_stock_p_70f8da_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="liberacion",
            index=models.Index(
                fields=["resultado", "fecha_solicitud"],
                name="producto_te_resulta_cef0cf_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="productoterminado",
            index=models.Index(
                fields=["empresa", "is_active"], name="producto_te_empresa_df52c4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="productoterminado",
            index=models.Index(
                fields=["tipo_producto", "is_active"],
                name="producto_te_tipo_pr_fcc844_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="productoterminado",
