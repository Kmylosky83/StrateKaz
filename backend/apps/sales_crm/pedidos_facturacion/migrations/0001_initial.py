    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["codigo"], name="sales_crm_c_codigo_7267e5_idx"
                    ),
                    models.Index(
                        fields=["activo", "orden"], name="sales_crm_c_activo_c2e617_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["codigo"], name="sales_crm_e_codigo_aeded3_idx"
                    ),
                    models.Index(
                        fields=["activo", "orden"], name="sales_crm_e_activo_d4b4a5_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["codigo"], name="sales_crm_m_codigo_6b6e4d_idx"
                    ),
                    models.Index(
                        fields=["activo", "orden"], name="sales_crm_m_activo_a76d58_idx"
                    ),
                ],
            },
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="pedidos",
                        to="pedidos_facturacion.condicionpago",
                        verbose_name="Condición de Pago",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="pedidos",
                        to="pedidos_facturacion.estadopedido",
                        verbose_name="Estado",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="pagos",
                        to="pedidos_facturacion.metodopago",
                        verbose_name="Método de Pago",
                    ),
                ),
                (
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["empresa", "factura"],
                        name="sales_crm_p_empresa_aefb35_idx",
                    ),
                    models.Index(
                        fields=["empresa", "fecha_pago"],
                        name="sales_crm_p_empresa_e5af59_idx",
                    ),
                    models.Index(
                        fields=["codigo"], name="sales_crm_p_codigo_95405a_idx"
                    ),
                ],
            },
        ),
        migrations.AddIndex(
            model_name="pedido",
            index=models.Index(
                fields=["empresa", "codigo"], name="sales_crm_p_empresa_0b0ff1_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="pedido",
            index=models.Index(
                fields=["empresa", "cliente"], name="sales_crm_p_empresa_ab6ed8_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="pedido",
            index=models.Index(
                fields=["empresa", "vendedor"], name="sales_crm_p_empresa_5342e8_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="pedido",
            index=models.Index(
                fields=["empresa", "estado"], name="sales_crm_p_empresa_19284b_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="pedido",
            index=models.Index(
                fields=["empresa", "fecha_pedido"],
                name="sales_crm_p_empresa_197f09_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="pedido",
        ...
        migrations.AddIndex(
            model_name="factura",
            index=models.Index(
                fields=["empresa", "codigo"], name="sales_crm_f_empresa_a131d2_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="factura",
            index=models.Index(
                fields=["empresa", "cliente"], name="sales_crm_f_empresa_a6e09c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="factura",
            index=models.Index(
                fields=["empresa", "pedido"], name="sales_crm_f_empresa_1705bf_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="factura",
            index=models.Index(
                fields=["empresa", "estado"], name="sales_crm_f_empresa_de26d8_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="factura",
            index=models.Index(
                fields=["empresa", "fecha_factura"],
                name="sales_crm_f_empresa_6898fd_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="factura",
            index=models.Index(
                ...
                name="sales_crm_f_empresa_49df8c_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="factura",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["empresa", "pedido"], name="sales_crm_d_empresa_d3473b_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="detallepedido",
            index=models.Index(
                fields=["empresa", "producto"], name="sales_crm_d_empresa_e31854_idx"
            ),
        ),
    ]
