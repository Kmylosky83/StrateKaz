    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["codigo"], name="pipeline_et_codigo_6c9fb8_idx"
                    ),
                    models.Index(
                        fields=["orden", "activo"], name="pipeline_et_orden_a58290_idx"
                    ),
                ],
            },
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="oportunidades",
                        to="pipeline_ventas.fuenteoportunidad",
                        verbose_name="Fuente",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="pipeline_ventas.motivoperdida",
                        verbose_name="Motivo de Pérdida",
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="pipeline_ventas.oportunidad",
                        verbose_name="Oportunidad",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["cotizacion", "orden"],
                        name="pipeline_de_cotizac_7f7a6f_idx",
                    )
                ],
            },
        ),
        ...
        migrations.AddIndex(
            model_name="oportunidad",
            index=models.Index(
                fields=["empresa", "etapa_actual"],
                name="pipeline_op_empresa_5dfca3_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="oportunidad",
            index=models.Index(
                fields=["vendedor", "etapa_actual"],
                name="pipeline_op_vendedo_afdefe_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="oportunidad",
            index=models.Index(
                fields=["fecha_cierre_estimada"], name="pipeline_op_fecha_c_fc94c6_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["oportunidad", "fecha_cambio"],
                name="pipeline_hi_oportun_d4639c_idx",
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name="cotizacion",
            index=models.Index(
                fields=["empresa", "estado"], name="pipeline_co_empresa_0dd367_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="cotizacion",
            index=models.Index(
                fields=["cliente", "estado"], name="pipeline_co_cliente_57dc17_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="cotizacion",
            index=models.Index(
                fields=["fecha_vencimiento"], name="pipeline_co_fecha_v_b6f5bd_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="cotizacion",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["oportunidad", "fecha"], name="pipeline_se_oportun_2e802f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="seguimientooportunidad",
            index=models.Index(
                fields=["fecha_proxima"], name="pipeline_se_fecha_p_b607df_idx"
            ),
        ),
    ]
