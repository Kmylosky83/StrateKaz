# Generated by Django 5.0.9 on 2025-12-29 17:34
    ...
    operations = [
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        ...
                        name="talent_hub__empresa_f60fac_idx",
                    ),
                ],
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "ordering": ["-fecha", "colaborador"],
                "indexes": [
                    models.Index(fields=["fecha"], name="talent_hub__fecha_1125d4_idx"),
                    models.Index(
                        fields=["colaborador", "fecha"],
                        name="talent_hub__colabor_1d9cda_idx",
                    ),
                    models.Index(
                        fields=["estado"], name="talent_hub__estado_3c4a23_idx"
                    ),
                    models.Index(fields=["tipo"], name="talent_hub__tipo_86fc73_idx"),
                    models.Index(
                        fields=["empresa", "fecha"],
                        name="talent_hub__empresa_679c94_idx",
                    ),
                ],
            },
        ),
