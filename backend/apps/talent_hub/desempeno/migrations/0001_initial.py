    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "indicadores_basico",
                    models.TextField(
                        blank=True, help_text="Comportamientos nivel básico"
                    ),
                ),
                (
                    "indicadores_intermedio",
                    models.TextField(
                        blank=True, help_text="Comportamientos nivel intermedio"
                    ),
                ),
                (
                    "indicadores_avanzado",
                    models.TextField(
                        blank=True, help_text="Comportamientos nivel avanzado"
                    ),
                ),
                (
                    "indicadores_experto",
                    models.TextField(
                        blank=True, help_text="Comportamientos nivel experto"
                    ),
                ),
                (
                    "peso",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="desempeno.competenciaevaluacion",
                    ),
                ),
                (
                    "created_by",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "color",
                    models.CharField(
                        default="#808080", help_text="Color HEX", max_length=7
                    ),
                ),
                (
                    "ciclo",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="detalles_evaluacion",
                        to="desempeno.criterioevaluacion",
                    ),
                ),
                (
                    "empresa",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="desempeno.evaluaciondesempeno",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "evidencia",
                    models.TextField(blank=True, help_text="Descripción de evidencias"),
                ),
                (
                    "created_by",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "icono",
                    models.CharField(
                        blank=True, help_text="Clase de ícono", max_length=50
                    ),
                ),
                (
                    "color",
                    models.CharField(
                        default="#FFD700", help_text="Color HEX", max_length=7
                    ),
                ),
                ("puntos_otorgados", models.PositiveIntegerField(default=0)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT,
                related_name="reconocimientos",
                to="desempeno.tiporeconocimiento",
            ),
        ),
        migrations.AddIndex(
            model_name="cicloevaluacion",
            index=models.Index(
                fields=["empresa", "anio", "periodo"],
                name="talent_cicl_empresa_104581_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="cicloevaluacion",
            index=models.Index(
                fields=["empresa", "estado"], name="talent_cicl_empresa_a09884_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="cicloevaluacion",
            constraint=models.UniqueConstraint(
                fields=("empresa", "codigo"), name="unique_ciclo_codigo"
            ),
        ),
        migrations.AddIndex(
            model_name="competenciaevaluacion",
            index=models.Index(
                fields=["empresa", "tipo_competencia"],
                name="talent_comp_empresa_3f7d86_idx",
            ),
        ),
        migrations.AddConstraint(
            model_name="escalacalificacion",
            constraint=models.UniqueConstraint(
                fields=("ciclo", "valor"), name="unique_escala_valor"
            ),
        ),
        migrations.AddIndex(
            model_name="evaluaciondesempeno",
            index=models.Index(
                fields=["empresa", "ciclo", "estado"],
                name="talent_eval_empresa_27a6e8_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="evaluaciondesempeno",
            index=models.Index(
                fields=["empresa", "colaborador"], name="talent_eval_empresa_3fb83a_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="evaluaciondesempeno",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("evaluacion", "evaluador"), name="unique_evaluador_par"
            ),
        ),
        migrations.AddIndex(
            model_name="planmejora",
            index=models.Index(
                fields=["empresa", "colaborador", "estado"],
                name="talent_plan_empresa_b38dfc_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="reconocimiento",
            index=models.Index(
                fields=["empresa", "colaborador", "estado"],
                name="talent_reco_empresa_3c1895_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="reconocimiento",
            index=models.Index(
                fields=["empresa", "fecha_reconocimiento"],
                name="talent_reco_empresa_201354_idx",
            ),
        ),
    ]
