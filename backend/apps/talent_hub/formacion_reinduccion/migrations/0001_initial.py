    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "codigo",
                    models.CharField(max_length=20, verbose_name="Código del Badge"),
                ),
                (
                    "nombre",
                    models.CharField(max_length=100, verbose_name="Nombre del Badge"),
                ),
                (
                    "descripcion",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0, verbose_name="Capacitaciones Requeridas"
                    ),
                ),
                (
                    "criterio_especial",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "puntos_totales",
                    models.PositiveIntegerField(
                        default=0, verbose_name="Puntos Totales"
                    ),
                ),
                (
                    "puntos_mes",
                    models.PositiveIntegerField(
                        default=0, verbose_name="Puntos del Mes"
                    ),
                ),
                (
                    "puntos_anio",
                    models.PositiveIntegerField(
                        default=0, verbose_name="Puntos del Año"
                    ),
                ),
                (
                    "nivel",
                    models.PositiveIntegerField(default=1, verbose_name="Nivel Actual"),
                ),
                (
                    "nombre_nivel",
                    models.CharField(
                        default="Novato", max_length=50, verbose_name="Nombre del Nivel"
                    ),
                ),
                (
                    "capacitaciones_completadas",
                    models.PositiveIntegerField(
                        default=0, verbose_name="Capacitaciones Completadas"
                    ),
                ),
                (
                    "badges_obtenidos",
                    models.PositiveIntegerField(
                        default=0, verbose_name="Badges Obtenidos"
                    ),
                ),
                (
                    "racha_actual",
                    models.PositiveIntegerField(
                        default=0, verbose_name="Racha Actual (días)"
                    ),
                ),
                (
                    "racha_maxima",
                    models.PositiveIntegerField(
                        default=0, verbose_name="Racha Máxima (días)"
                    ),
                ),
                (
                    "posicion_ranking",
                    models.PositiveIntegerField(
                        blank=True, null=True, verbose_name="Posición en Ranking"
                    ),
                ),
                (
                    "ultima_actividad",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "anio",
                    models.PositiveIntegerField(db_index=True, verbose_name="Año"),
                ),
                (
                ...
                (
                    "aprobado",
                    models.BooleanField(default=False, verbose_name="Plan Aprobado"),
                ),
                (
                    "fecha_aprobacion",
                    models.DateField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nombre",
                    models.CharField(
                        max_length=200, verbose_name="Nombre de la Capacitación"
                    ),
                ),
                (
                    "descripcion",
                ...
                (
                    "instructor_externo",
                    models.CharField(
                        blank=True, max_length=200, verbose_name="Instructor Externo"
                    ),
                ),
                (
                    "proveedor_externo",
                ...
                (
                    "contenido_tematico",
                    models.JSONField(
                        blank=True, default=list, verbose_name="Contenido Temático"
                    ),
                ),
                (
                    "material_apoyo",
                ...
                (
                    "cupo_maximo",
                    models.PositiveIntegerField(default=20, verbose_name="Cupo Máximo"),
                ),
                (
                    "cupo_minimo",
                    models.PositiveIntegerField(default=5, verbose_name="Cupo Mínimo"),
                ),
                (
                    "requisitos_previos",
                    models.TextField(blank=True, verbose_name="Requisitos Previos"),
                ),
                (
                    "requiere_evaluacion",
                    models.BooleanField(
                        default=True, verbose_name="Requiere Evaluación"
                    ),
                ),
                (
                    "nota_aprobacion",
                ...
                (
                    "genera_certificado",
                    models.BooleanField(
                        default=True, verbose_name="Genera Certificado"
                    ),
                ),
                (
                    "costo_por_persona",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="formacion_reinduccion.planformacion",
                        verbose_name="Plan de Formación",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "numero_sesion",
                    models.PositiveIntegerField(
                        default=1, verbose_name="Número de Sesión"
                    ),
                ),
                (
                    "titulo_sesion",
                    models.CharField(
                        blank=True, max_length=200, verbose_name="Título de la Sesión"
                    ),
                ),
                ...
                (
                    "lugar",
                    models.CharField(max_length=200, verbose_name="Lugar/Ubicación"),
                ),
                (
                    "direccion",
                    models.CharField(
                ...
                (
                    "enlace_virtual",
                    models.URLField(blank=True, verbose_name="Enlace Reunión Virtual"),
                ),
                (
                    "instructor_externo",
                    models.CharField(
                ...
                (
                    "inscritos",
                    models.PositiveIntegerField(default=0, verbose_name="Inscritos"),
                ),
                (
                    "estado",
                    models.CharField(
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="formacion_reinduccion.capacitacion",
                        verbose_name="Capacitación",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True, verbose_name="Justificación de Inasistencia"
                    ),
                ),
                (
                    "nota_evaluacion",
                ...
                (
                    "intentos_evaluacion",
                    models.PositiveIntegerField(
                        default=0, verbose_name="Intentos de Evaluación"
                    ),
                ),
                (
                ...
                (
                    "puntos_ganados",
                    models.PositiveIntegerField(
                        default=0, verbose_name="Puntos Ganados"
                    ),
                ),
                (
                    "retroalimentacion",
                    models.TextField(
                        blank=True, verbose_name="Retroalimentación del Participante"
                    ),
                ),
                (
                    "calificacion_instructor",
                    models.PositiveIntegerField(
                        blank=True,
                        null=True,
                        validators=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="formacion_reinduccion.programacioncapacitacion",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fecha_obtencion",
                    models.DateTimeField(
                        auto_now_add=True, verbose_name="Fecha de Obtención"
                    ),
                ),
                (
                    "motivo",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="formacion_reinduccion.badge",
                        verbose_name="Badge",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "titulo_capacitacion",
                    models.CharField(
                        max_length=200, verbose_name="Título de la Capacitación"
                    ),
                ),
                (
                    "duracion_horas",
                    models.PositiveIntegerField(verbose_name="Duración (horas)"),
                ),
                (
                    "nota_obtenida",
                    models.DecimalField(
                ...
                (
                    "cargo_firmante",
                    models.CharField(
                        blank=True, max_length=100, verbose_name="Cargo del Firmante"
                    ),
                ),
                (
                    "archivo_certificado",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="formacion_reinduccion.ejecucioncapacitacion",
                        verbose_name="Ejecución de Capacitación",
                    ),
                ),
            ],
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="talent_hub__numero__26307a_idx",
                    ),
                    models.Index(
                        fields=["ejecucion"], name="talent_hub__ejecuci_9892ba_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "evidencias",
                    models.TextField(
                        blank=True, verbose_name="Evidencias de Aplicación"
                    ),
                ),
                (
                    "mejoras_observadas",
                    models.TextField(blank=True, verbose_name="Mejoras Observadas"),
                ),
                (
                    "areas_oportunidad",
                    models.TextField(blank=True, verbose_name="Áreas de Oportunidad"),
                ),
                (
                    "requiere_refuerzo",
                    models.BooleanField(
                        default=False, verbose_name="Requiere Refuerzo"
                    ),
                ),
                (
                    "recomendaciones",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["ejecucion", "nivel_evaluacion"],
                        name="talent_hub__ejecuci_ab8bd3_idx",
                    )
                ],
            },
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["empresa", "anio"], name="talent_hub__empresa_fa4bb9_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["empresa", "tipo_capacitacion"],
                name="talent_hub__empresa_801302_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="capacitacion",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["colaborador", "estado"], name="talent_hub__colabor_1fd949_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="ejecucioncapacitacion",
