...
NOTIFICATION_TYPES = [
    {
        ...
        'color': 'red',
        'icono': 'AlertTriangle',
        'plantilla_titulo': 'Citación a Descargos',
    ...
    },
    {
        ...
        'nombre': 'Sanción aplicada',
        'descripcion': 'Notifica al colaborador que se le aplicó una sanción.',
        'categoria': 'alerta',
        'color': 'red',
        'icono': 'AlertCircle',
        'plantilla_titulo': 'Sanción Aplicada',
        'plantilla_mensaje': 'Se ha aplicado una sanción disciplinaria.',
        'es_email': True,
        'es_push': True,
    },
    {
        ...
        'descripcion': 'Alerta de contrato próximo a vencer.',
        'categoria': 'recordatorio',
        'color': 'yellow',
        'icono': 'FileWarning',
        'plantilla_titulo': 'Contrato por Vencer',
        'plantilla_mensaje': 'El contrato de {colaborador} vence en {dias} días.',
        'es_email': True,
        'es_push': False,
    },
    {
        ...
        'descripcion': 'Confirmación de firma de contrato.',
        'categoria': 'sistema',
        'color': 'green',
        'icono': 'FileCheck',
    ...
    },
    {
        ...
        'descripcion': 'Un colaborador solicitó vacaciones.',
        'categoria': 'aprobacion',
        'color': 'blue',
        'icono': 'Calendar',
        'plantilla_titulo': 'Solicitud de Vacaciones',
        'plantilla_mensaje': '{colaborador} solicitó vacaciones del {inicio} al {fin}.',
        'es_email': True,
        'es_push': True,
    },
    {
    ...
    },
    {
        ...
        'descripcion': 'Un colaborador solicitó un permiso.',
        'categoria': 'aprobacion',
        'color': 'blue',
        'icono': 'FileText',
        'plantilla_titulo': 'Solicitud de Permiso',
        'plantilla_mensaje': '{colaborador} solicitó un permiso para {fecha}.',
        'es_email': True,
        'es_push': True,
    },
    {
        ...
        'descripcion': 'Se registró una incapacidad.',
        'categoria': 'alerta',
        'color': 'orange',
        'icono': 'HeartPulse',
        'plantilla_titulo': 'Incapacidad Registrada',
        'plantilla_mensaje': 'Se registró incapacidad de {colaborador}.',
        'es_email': True,
        'es_push': False,
    },
    {
        'codigo': 'TH_CAPACITACION_PROGRAMADA',
        'nombre': 'Capacitación programada',
        'descripcion': 'Se programó una nueva capacitación.',
        'categoria': 'recordatorio',
        'color': 'purple',
        'icono': 'GraduationCap',
        'plantilla_titulo': 'Capacitación Programada',
        'plantilla_mensaje': 'Tiene una capacitación programada: {nombre}.',
        'es_email': True,
        'es_push': True,
    },
    {
        ...
        'descripcion': 'Tiene una evaluación de desempeño pendiente.',
        'categoria': 'tarea',
        'color': 'teal',
        'icono': 'ClipboardCheck',
        'plantilla_titulo': 'Evaluación de Desempeño Pendiente',
        'plantilla_mensaje': 'Tiene una evaluación de desempeño pendiente.',
        'es_email': True,
        'es_push': True,
    },
    {
    ...
    },
    {
        ...
        'descripcion': 'El periodo de prueba de un colaborador está por finalizar.',
        'categoria': 'recordatorio',
        'color': 'yellow',
        'icono': 'Clock',
        'plantilla_titulo': 'Periodo de Prueba',
        'plantilla_mensaje': 'El periodo de prueba de {colaborador} finaliza en {dias} días.',
        'es_email': True,
        'es_push': False,
    },
    {
        'codigo': 'TH_HORAS_EXTRA_LIMITE',
        'nombre': 'Límite de horas extra',
        'descripcion': 'Un colaborador está cerca del límite semanal de horas extra.',
        'categoria': 'alerta',
        'color': 'orange',
        'icono': 'AlertTriangle',
        'plantilla_titulo': 'Límite de Horas Extra',
        'plantilla_mensaje': '{colaborador} tiene {horas}h extra esta semana (límite: 12h).',
        'es_email': True,
        'es_push': False,
    },
    {
        'codigo': 'TH_NOMINA_LIQUIDADA',
        'nombre': 'Nómina liquidada',
        'descripcion': 'Su recibo de nómina está disponible.',
        'categoria': 'sistema',
        'color': 'green',
        'icono': 'DollarSign',
        'plantilla_titulo': 'Recibo de Nómina Disponible',
        'plantilla_mensaje': 'Su recibo de nómina del periodo {periodo} está disponible.',
        'es_email': True,
        'es_push': True,
    },
]
