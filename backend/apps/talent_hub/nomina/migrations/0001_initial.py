    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nombre",
                    models.CharField(
                        max_length=100, verbose_name="Nombre del Concepto"
                    ),
                ),
                (
                    "descripcion",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "anio",
                    models.PositiveIntegerField(
                        help_text="Año fiscal de aplicación", verbose_name="Año"
                    ),
                ),
                (
                    "salario_minimo",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fecha_pago",
                    models.DateField(db_index=True, verbose_name="Fecha de Pago"),
                ),
                (
                    "metodo_pago",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fecha_fin",
                    models.DateField(
                        help_text="Último día del periodo", verbose_name="Fecha de Fin"
                    ),
                ),
                (
                    "fecha_pago",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["empresa", "codigo"], name="talent_hub__empresa_420b93_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="conceptonomina",
            index=models.Index(
                fields=["tipo", "categoria"], name="talent_hub__tipo_4cb1a6_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["empresa", "anio"], name="talent_hub__empresa_814812_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="configuracionnomina",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["liquidacion", "concepto"],
                name="talent_hub__liquida_b43805_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="pagonomina",
            index=models.Index(
                fields=["liquidacion", "fecha_pago"],
                name="talent_hub__liquida_ef34c3_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="pagonomina",
            index=models.Index(
                fields=["fecha_pago"], name="talent_hub__fecha_p_e43623_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="periodonomina",
            index=models.Index(
                fields=["empresa", "anio", "mes"], name="talent_hub__empresa_540675_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="periodonomina",
        ...
        migrations.AddIndex(
            model_name="periodonomina",
            index=models.Index(
                fields=["fecha_pago"], name="talent_hub__fecha_p_9ab21b_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="periodonomina",
        ...
        migrations.AddIndex(
            model_name="liquidacionnomina",
            index=models.Index(
                fields=["periodo", "colaborador"], name="talent_hub__periodo_519028_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="liquidacionnomina",
        ...
        migrations.AddIndex(
            model_name="liquidacionnomina",
            index=models.Index(
                fields=["empresa", "periodo"], name="talent_hub__empresa_2d2187_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="liquidacionnomina",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["colaborador", "anio"], name="talent_hub__colabor_fd040e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="prestacion",
            index=models.Index(
                fields=["tipo", "estado"], name="talent_hub__tipo_59e97c_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="prestacion",
