...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "motivo",
                    models.TextField(
                        help_text="Motivo detallado del permiso", verbose_name="Motivo"
                    ),
                ),
                (
                    "tipo",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="novedades.periodovacaciones",
                        verbose_name="Período de Vacaciones",
                    ),
                ),
                (
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["empresa", "colaborador"], name="talent_hub__empresa_d48e7d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="periodovacaciones",
            index=models.Index(
                fields=["ultimo_corte"], name="talent_hub__ultimo__246321_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="permiso",
            index=models.Index(
                fields=["empresa", "colaborador"], name="talent_hub__empresa_48e148_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="permiso",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["empresa", "colaborador"], name="talent_hub__empresa_e83180_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="solicitudvacaciones",
            index=models.Index(
                ...
                name="talent_hub__fecha_i_c768b2_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="solicitudvacaciones",
        ...
        migrations.AddIndex(
            model_name="solicitudvacaciones",
            index=models.Index(
                fields=["periodo"], name="talent_hub__periodo_e8c95e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="tipoincapacidad",
            index=models.Index(
                fields=["empresa", "is_active"], name="talent_hub__empresa_ba427f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="tipoincapacidad",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["empresa", "colaborador"], name="talent_hub__empresa_45f440_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="incapacidad",
            index=models.Index(
                fields=["fecha_inicio", "fecha_fin"],
                name="talent_hub__fecha_i_4bc084_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="incapacidad",
        ...
        migrations.AddIndex(
            model_name="incapacidad",
            index=models.Index(
                fields=["numero_incapacidad"], name="talent_hub__numero__675512_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="tipolicencia",
            index=models.Index(
                fields=["empresa", "is_active"], name="talent_hub__empresa_24b5f4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="tipolicencia",
        ...
        migrations.AddIndex(
            model_name="tipolicencia",
            index=models.Index(
                fields=["categoria"], name="talent_hub__categor_9d314a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="licencia",
            index=models.Index(
                fields=["empresa", "colaborador"], name="talent_hub__empresa_575e9e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="licencia",
            index=models.Index(
                fields=["fecha_inicio", "fecha_fin"],
                name="talent_hub__fecha_i_adf8a9_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="licencia",
        ...
        migrations.AddIndex(
            model_name="licencia",
            index=models.Index(
                fields=["tipo_licencia"], name="talent_hub__tipo_li_f82932_idx"
            ),
        ),
    ]
