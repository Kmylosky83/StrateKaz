...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="talent_hub__colabor_598bbe_idx",
                    ),
                    models.Index(
                        fields=["codigo_activo"], name="talent_hub__codigo__8a749e_idx"
                    ),
                ],
            },
        ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="talent_hub__colabor_8c4daf_idx",
                    ),
                    models.Index(
                        fields=["fecha_entrega"], name="talent_hub__fecha_e_263552_idx"
                    ),
                ],
            },
        ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="talent_hub__colabor_0c456b_idx",
                    ),
                    models.Index(
                        fields=["fecha_firma"], name="talent_hub__fecha_f_b041c3_idx"
                    ),
                ],
            },
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["empresa", "tipo_modulo"], name="talent_hub__empresa_a99826_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="moduloinduccion",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["colaborador", "estado"], name="talent_hub__colabor_10bf28_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="ejecucionintegral",
            index=models.Index(
                fields=["fecha_limite"], name="talent_hub__fecha_l_9d6e19_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="ejecucionintegral",
