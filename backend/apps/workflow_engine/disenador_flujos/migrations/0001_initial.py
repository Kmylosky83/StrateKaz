...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="disenador_flujos.categoriaflujo",
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        to="disenador_flujos.formulariodiligenciado",
                        verbose_name="Formulario Diligenciado",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "mensaje_validacion",
                    models.CharField(
                        blank=True, max_length=500, verbose_name="Mensaje de Validación"
                    ),
                ),
                (
                    "version",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="disenador_flujos.campoformulario",
                        verbose_name="Campo de Formulario",
                    ),
                ),
                (
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["empresa_id", "activo"], name="workflow_ca_empresa_449f90_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="categoriaflujo",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["empresa_id"], name="workflow_ca_empresa_61c2d0_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="campoformulario",
            index=models.Index(
                fields=["nodo", "orden"], name="workflow_ca_nodo_id_2e9f23_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="campoformulario",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["empresa_id", "estado"], name="workflow_pl_empresa_aecd90_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="plantillaflujo",
            index=models.Index(
                fields=["codigo", "version"], name="workflow_pl_codigo_eaca96_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="plantillaflujo",
            index=models.Index(
                fields=["categoria", "estado"], name="workflow_pl_categor_97a5e5_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="plantillaflujo",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["empresa_id", "estado"], name="workflow_fo_empresa_8468e3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="formulariodiligenciado",
            index=models.Index(
                fields=["plantilla_flujo", "estado"],
                name="workflow_fo_plantil_7599ad_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="formulariodiligenciado",
            index=models.Index(
                fields=["diligenciado_por", "-fecha_diligenciamiento"],
                name="workflow_fo_diligen_c08a20_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="formulariodiligenciado",
            index=models.Index(
                ...
                name="workflow_fo_content_6647fa_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="asignacionformulario",
            index=models.Index(
                fields=["empresa_id", "estado"], name="workflow_as_empresa_c7a281_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="asignacionformulario",
            index=models.Index(
                fields=["asignado_a", "estado"], name="workflow_as_asignad_baaa05_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="asignacionformulario",
            index=models.Index(
                fields=["fecha_limite"], name="workflow_as_fecha_l_c88ea8_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="asignacionformulario",
            index=models.Index(
                fields=["area_id", "estado"], name="workflow_as_area_id_43323d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="respuestacampo",
            index=models.Index(
                fields=["formulario_diligenciado", "campo_formulario"],
                name="workflow_re_formula_972bff_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="respuestacampo",
            index=models.Index(
                ...
                name="workflow_re_modific_42257c_idx",
            ),
        ),
        migrations.AlterUniqueTogether(
            name="respuestacampo",
        ...
        migrations.AddIndex(
            model_name="rolflujo",
            index=models.Index(
                fields=["empresa_id", "activo"], name="workflow_ro_empresa_7411ce_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="rolflujo",
            index=models.Index(
                fields=["tipo_asignacion"], name="workflow_ro_tipo_as_82acf9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="rolflujo",
            index=models.Index(
                fields=["rol_sistema_id"], name="workflow_ro_rol_sis_49ca0f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="rolflujo",
            index=models.Index(
                fields=["cargo_id"], name="workflow_ro_cargo_i_c779d0_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="rolflujo",
            index=models.Index(
                fields=["usuario_id"], name="workflow_ro_usuario_f57314_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="rolflujo",
        ...
        migrations.AddIndex(
            model_name="nodoflujo",
            index=models.Index(
                fields=["empresa_id", "tipo"], name="workflow_no_empresa_a1acdb_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="nodoflujo",
            index=models.Index(
                fields=["plantilla", "tipo"], name="workflow_no_plantil_444b41_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="nodoflujo",
            index=models.Index(
                fields=["rol_asignado"], name="workflow_no_rol_asi_874653_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="nodoflujo",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["empresa_id"], name="workflow_tr_empresa_12a343_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="transicionflujo",
            index=models.Index(
                fields=["plantilla", "nodo_origen"],
                name="workflow_tr_plantil_c2d861_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="transicionflujo",
            index=models.Index(
                fields=["nodo_origen", "nodo_destino"],
                name="workflow_tr_nodo_or_27169b_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="transicionflujo",
            index=models.Index(
                fields=["-prioridad"], name="workflow_tr_priorid_8cdbf5_idx"
            ),
        ),
    ]
