...
class WorkflowExecutionService:
    ...
    def iniciar_flujo(
        ...
        """
        from apps.workflow_engine.disenador_flujos.models import (
            PlantillaFlujo, NodoFlujo,
        )
        from apps.workflow_engine.ejecucion.models import InstanciaFlujo
        from apps.workflow_engine.ejecucion.signals import workflow_iniciado
    ...
    def completar_tarea_y_avanzar(
        ...
        from apps.workflow_engine.ejecucion.signals import tarea_completada
    ...
    def rechazar_tarea(
        ...
        """
        from apps.workflow_engine.ejecucion.models import TareaActiva
        from apps.workflow_engine.ejecucion.signals import tarea_rechazada
