...
def enviar_notificacion_workflow(self, notificacion_id: int):
    """
...
def ejecutar_evento_temporizador(self, instancia_id: int, nodo_evento_id: int):
    """
    ...
    # Validar que la instancia sigue activa
...
def actualizar_metricas_flujo(self):
    ...
    for plantilla in plantillas:
        ...
        # Tiempo promedio de instancias completadas
        ...
        # Cuellos de botella: nodos con mayor tiempo promedio
        cuellos = list(
            tareas.filter(
                estado='COMPLETADA',
    ...
    result = {
        'plantillas_procesadas': actualizadas,
