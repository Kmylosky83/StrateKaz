...
Guía para configurar la identidad visual de su empresa en el sistema.

## Acceso

**Ruta:** Dirección Estratégica → Configuración → Branding
...
| Color | Uso | Ejemplo |
|-------|-----|---------|
| **Primario** | Botones principales, links | Azul corporativo |
| **Secundario** | Elementos secundarios | Morado |
| **Acento** | Destacados, alertas | Verde |
...
Sí, los cambios se aplican inmediatamente en toda la aplicación sin necesidad de recargar.

### ¿Puedo tener múltiples configuraciones?

Sí, pero solo una puede estar activa a la vez. Útil para pruebas o cambios estacionales.

### ¿Qué pasa si no subo logos?

El sistema mostrará el nombre de la empresa en texto.

### ¿Puedo volver a la configuración anterior?

Sí, puede desactivar la configuración actual y activar una anterior.

---

## Soporte

Si tiene problemas con la configuración de marca, contacte al equipo de soporte técnico.
