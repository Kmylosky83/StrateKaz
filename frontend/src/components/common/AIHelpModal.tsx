...
function detectModuleFromPath(pathname: string): string {
  const routeToModule: Record<string, string> = {
    ...
    '/planificacion-operativa': 'planificacion_operativa',
    '/proteccion': 'proteccion_cumplimiento',
    '/cumplimiento': 'proteccion_cumplimiento',
    '/riesgos': 'proteccion_cumplimiento',
    '/acciones-mejora': 'acciones_mejora',
    '/workflows': 'infra_workflow_engine',
    '/gestion-integral': 'gestion_integral',
    '/hseq': 'gestion_integral',
    '/sistema-gestion': 'infra_gestion_documental',
