 ...
 *
 * Gestion de informes financieros con datos reales del backend:
 * - Definiciones: Catalogo de informes disponibles
              ...
              <Card variant="bordered" padding="lg">
                <div className="text-center py-8">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">
                    Sin informes definidos
                  </h3>
                  <p className="text-gray-500">
                    No se encontraron definiciones de informes contables
                  </p>
                </div>
              </Card>
            ) : (
              ...
              {selected ? (
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    {selected.descripcion || 'Sin descripcion'}
                  </p>

                  {/* Lineas del informe */}
                  <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                    <p className="text-xs font-medium text-gray-500 uppercase mb-2">
                      Lineas configuradas ({lineas.length})
                    </p>
                    {lineas.length === 0 ? (
                      <p className="text-xs text-gray-400 text-center py-4">
                        Sin lineas configuradas
                      </p>
                    ) : (
      ...
      {generaciones.length === 0 ? (
        <Card variant="bordered" padding="lg">
          <div className="text-center py-8">
            ...
            <p className="text-gray-500">No se han generado informes contables aun</p>
          </div>
        </Card>
      ) : (
...
export default function InformesContablesPage() {
  ...
  const pendientes = generaciones.filter(
    (g: any) => g.estado === 'generando' || g.estado === 'pendiente'
  );
