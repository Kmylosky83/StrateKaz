...
const ADMIN_MODULE_COLOR = 'indigo' as const;
const colors = getModuleColorClasses(ADMIN_MODULE_COLOR);
  ...
  return (
    <div className="space-y-6">
      ...
      {isStatsLoading ? (
        ...
        <StatsGrid stats={statsItems} columns={4} moduleColor={ADMIN_MODULE_COLOR} />
      )}
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            <div className={`p-2 rounded-lg ${colors.badge}`}>
              <activeSectionData.icon className={`h-5 w-5 ${colors.icon}`} />
            </div>
            <div>
