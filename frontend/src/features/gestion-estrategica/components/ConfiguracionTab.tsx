            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-lg font-semibold text-gray-900 dark:text-gray-100">
                  {branding?.company_name || 'No configurado'}
                </p>
              </div>
              <div>
                <label className="text-sm font-medium text-gray-500 dark:text-gray-400">
                ...
                <p className="text-gray-900 dark:text-gray-100">
                  {branding?.company_short_name || 'No configurado'}
                </p>
              </div>
...
const ModulosAndFeaturesSection = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <Alert
        variant="info"
        message="Los módulos controlan qué funcionalidades están disponibles en el sistema. Los cambios se aplican inmediatamente y pueden afectar elementos dependientes."
      />
