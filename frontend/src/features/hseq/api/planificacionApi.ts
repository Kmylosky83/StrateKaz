/**
 * API Client para Planificacion del Sistema - HSEQ Management
...
const BASE_URL = '/api/hseq/planificacion-sistema';
...
export const planTrabajoApi = {
  ...
  getEstadisticas: async (id: number): Promise<EstadisticasPlanTrabajo> => {
    const response = await apiClient.get(`${BASE_URL}/planes-trabajo/${id}/estadisticas/`);
    return response.data;
  },
};
...
export const actividadPlanApi = {
  ...
  actualizarAvance: async (
    ...
    const response = await apiClient.post(`${BASE_URL}/actividades-plan/${id}/actualizar-avance/`, {
...
export const objetivoSistemaApi = {
  ...
  getAll: async (params?: {
    ...
    const response = await apiClient.get(`${BASE_URL}/objetivos-sistema/`, { params });
    return response.data;
  },
  ...
  getById: async (id: number): Promise<ObjetivoSistema> => {
    const response = await apiClient.get(`${BASE_URL}/objetivos-sistema/${id}/`);
    return response.data;
  },
  ...
  create: async (data: CreateObjetivoSistemaDTO): Promise<ObjetivoSistema> => {
    const response = await apiClient.post(`${BASE_URL}/objetivos-sistema/`, data);
    return response.data;
  },
  ...
  update: async (id: number, data: UpdateObjetivoSistemaDTO): Promise<ObjetivoSistema> => {
    const response = await apiClient.patch(`${BASE_URL}/objetivos-sistema/${id}/`, data);
    return response.data;
  },
   ...
   */
  delete: async (id: number): Promise<void> => {
    await apiClient.delete(`${BASE_URL}/objetivos-sistema/${id}/`);
  },
  ...
  actualizarCumplimiento: async (
    ...
    const response = await apiClient.post(`${BASE_URL}/objetivos-sistema/${id}/actualizar-cumplimiento/`, {
      valor_actual,
  ...
  porPerspectiva: async (
    ...
    const response = await apiClient.get(`${BASE_URL}/objetivos-sistema/`, {
...
export const programaGestionApi = {
  ...
  getAll: async (params?: {
    ...
    const response = await apiClient.get(`${BASE_URL}/programas-gestion/`, { params });
    return response.data;
  },
  ...
  getById: async (id: number): Promise<ProgramaGestion> => {
    const response = await apiClient.get(`${BASE_URL}/programas-gestion/${id}/`);
    return response.data;
  },
  ...
  create: async (data: CreateProgramaGestionDTO): Promise<ProgramaGestion> => {
    const response = await apiClient.post(`${BASE_URL}/programas-gestion/`, data);
    return response.data;
  },
  ...
  update: async (id: number, data: UpdateProgramaGestionDTO): Promise<ProgramaGestion> => {
    const response = await apiClient.patch(`${BASE_URL}/programas-gestion/${id}/`, data);
    return response.data;
  },
   ...
   */
  delete: async (id: number): Promise<void> => {
    await apiClient.delete(`${BASE_URL}/programas-gestion/${id}/`);
  },
  ...
  actualizarAvance: async (id: number, porcentaje: number): Promise<ProgramaGestion> => {
    const response = await apiClient.post(`${BASE_URL}/programas-gestion/${id}/actualizar-avance/`, {
      porcentaje_avance: porcentaje,
    });
    return response.data;
  },
  ...
  porPlan: async (planId: number): Promise<ProgramaGestion[]> => {
    const response = await apiClient.get(`${BASE_URL}/programas-gestion/`, {
      params: { plan_trabajo: planId },
    });
    return response.data.results || response.data;
  },
...
export const actividadProgramaApi = {
   ...
   */
  ejecutar: async (id: number, resultado: string, evidencias?: string): Promise<ActividadPrograma> => {
...
export const seguimientoCronogramaApi = {
  ...
  getAll: async (params?: {
    ...
    const response = await apiClient.get(`${BASE_URL}/seguimientos-cronograma/`, { params });
    return response.data;
  },
  ...
  getById: async (id: number): Promise<SeguimientoCronograma> => {
    const response = await apiClient.get(`${BASE_URL}/seguimientos-cronograma/${id}/`);
    return response.data;
  },
  ...
  create: async (data: CreateSeguimientoCronogramaDTO): Promise<SeguimientoCronograma> => {
    const response = await apiClient.post(`${BASE_URL}/seguimientos-cronograma/`, data);
    return response.data;
  },
   ...
   */
  update: async (id: number, data: UpdateSeguimientoCronogramaDTO): Promise<SeguimientoCronograma> => {
    const response = await apiClient.patch(`${BASE_URL}/seguimientos-cronograma/${id}/`, data);
    return response.data;
  },
   ...
   */
  delete: async (id: number): Promise<void> => {
    await apiClient.delete(`${BASE_URL}/seguimientos-cronograma/${id}/`);
  },
  ...
  generarReporte: async (
    ...
    const response = await apiClient.get(`${BASE_URL}/seguimientos-cronograma/generar-reporte/`, {
  ...
  porPlan: async (planId: number): Promise<SeguimientoCronograma[]> => {
    const response = await apiClient.get(`${BASE_URL}/seguimientos-cronograma/`, {
      params: { plan_trabajo: planId },
    });
    return response.data.results || response.data;
  },
