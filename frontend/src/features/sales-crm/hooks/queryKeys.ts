...
export const salesCRMKeys = {
  ...
  clientesFiltered: (filters: Record<string, unknown>) => [...salesCRMKeys.clientes(), 'filtered', filters] as const,
  ...
  contactosFiltered: (filters: Record<string, unknown>) => [...salesCRMKeys.contactos(), 'filtered', filters] as const,
  ...
  oportunidadesFiltered: (filters: Record<string, unknown>) => [...salesCRMKeys.oportunidades(), 'filtered', filters] as const,
  ...
  actividadesFiltered: (filters: Record<string, unknown>) => [...salesCRMKeys.actividades(), 'filtered', filters] as const,

  // Cotizaciones
  cotizaciones: () => [...salesCRMKeys.all, 'cotizaciones'] as const,
  cotizacionById: (id: number) => [...salesCRMKeys.cotizaciones(), id] as const,
  cotizacionesFiltered: (filters: Record<string, unknown>) => [...salesCRMKeys.cotizaciones(), 'filtered', filters] as const,

  // Pedidos
  pedidos: () => [...salesCRMKeys.all, 'pedidos'] as const,
  pedidoById: (id: number) => [...salesCRMKeys.pedidos(), id] as const,
  pedidosFiltered: (filters: Record<string, unknown>) => [...salesCRMKeys.pedidos(), 'filtered', filters] as const,

  // Facturas
  facturas: () => [...salesCRMKeys.all, 'facturas'] as const,
  facturaById: (id: number) => [...salesCRMKeys.facturas(), id] as const,
  facturasFiltered: (filters: Record<string, unknown>) => [...salesCRMKeys.facturas(), 'filtered', filters] as const,

  // Pagos
  pagos: () => [...salesCRMKeys.all, 'pagos'] as const,
  pagoById: (id: number) => [...salesCRMKeys.pagos(), id] as const,
  pagosFiltered: (filters: Record<string, unknown>) => [...salesCRMKeys.pagos(), 'filtered', filters] as const,

  // PQRS
  pqrs: () => [...salesCRMKeys.all, 'pqrs'] as const,
  pqrsById: (id: number) => [...salesCRMKeys.pqrs(), id] as const,
  pqrsFiltered: (filters: Record<string, unknown>) => [...salesCRMKeys.pqrs(), 'filtered', filters] as const,
  pqrsDashboard: () => [...salesCRMKeys.pqrs(), 'dashboard'] as const,

  // Seguimiento PQRS
  seguimientoPQRS: () => [...salesCRMKeys.all, 'seguimiento-pqrs'] as const,
  seguimientoPQRSFiltered: (filters: Record<string, unknown>) => [...salesCRMKeys.seguimientoPQRS(), 'filtered', filters] as const,

  // Encuestas
  encuestas: () => [...salesCRMKeys.all, 'encuestas'] as const,
  encuestaById: (id: number) => [...salesCRMKeys.encuestas(), id] as const,
  encuestasFiltered: (filters: Record<string, unknown>) => [...salesCRMKeys.encuestas(), 'filtered', filters] as const,
  ...
  puntosFidelizacionFiltered: (filters: Record<string, unknown>) => [...salesCRMKeys.puntosFidelizacion(), 'filtered', filters] as const,

  // Movimientos de Puntos
  movimientosPuntos: () => [...salesCRMKeys.all, 'movimientos-puntos'] as const,
  movimientosPuntosFiltered: (filters: Record<string, unknown>) => [...salesCRMKeys.movimientosPuntos(), 'filtered', filters] as const,
};
