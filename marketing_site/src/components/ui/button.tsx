...
const buttonVariants = cva(
  'font-ui inline-flex items-center justify-center rounded-lg font-medium transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-black-deep disabled:opacity-50 disabled:cursor-not-allowed gap-2 min-h-[44px]',
  {
    variants: {
      variant: {
        // default es alias de primary para compatibilidad con shadcn/ui
        default:
        ...
        outline:
          'border border-brand-500 text-brand-500 hover:bg-brand-500 hover:text-white focus:ring-brand-500',
        destructive:
